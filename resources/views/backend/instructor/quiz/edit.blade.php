    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form class="row g-3" method="post" action="{{ route('instructor.quiz.update', $quiz->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" name="description" id="description" rows="3">{{ old('description', $quiz->description) }}</textarea>
                    </div>

                    <div class="col-md-6">
                        <label for="duration" class="form-label">Duration (minutes)</label>
                        <input type="number" class="form-control" name="duration" id="duration"
                            placeholder="Enter duration in minutes" value="{{ old('duration', $quiz->duration) }}">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" class="form-control" name="start_at" id="start_at"
                            value="{{ old('start_at', $quiz->start_at) }}">
                    </div>

                    <div class="col-md-6">
                        <label for="end_at" class="form-label">End Date/Time</label>
                        <input type="datetime-local" class="form-control" name="end_at" id="end_at"
                            value="{{ old('end_at', $quiz->end_at) }}">
                    </div>

                    <div class="col-md-12">
                        <div class="d-md-flex d-grid align-items-center gap-3">
                            <button type="submit" class="btn btn-primary px-4 w-100">Update Quiz</button>
                        </div>
                    </div>
                </form>
            </div>
